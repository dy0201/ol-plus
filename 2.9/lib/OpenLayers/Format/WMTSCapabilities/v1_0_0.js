...
OpenLayers.Format.WMTSCapabilities.v1_0_0 = OpenLayers.Class(
    ...
    initialize: function(options) {
        ...
        // add wmts namespace alias
        this.setNamespace("wmts", "http://www.opengis.net/wmts/1.0");
    },
    ...
    readers: {        
        "wmts": {
            ...
            "TileMatrixSet": function(node, obj) {
            	if(node.parentNode.localName == "TileMatrixSetLink") {
            		// TileMatrixSet as string type in schema
            		obj.tileMatrixSet = this.getChildValue(node);
            	} else if(node.parentNode.localName == "Contents") {
            		// TileMatrixSet as object type in schema
            		var tileMatrixSet = {};
            		tileMatrixSet.tileMatrics = [];
            ...
            "TileMatrix": function(node, obj) {
            	...
            	obj.tileMatrics.push(tileMatrix);
            },
